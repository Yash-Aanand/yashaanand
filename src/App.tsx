      ...
      <div className="content-wrapper">
        ...
        >
          <div className="max-w-4xl mx-auto">
            <h2 className="text-5xl font-bold pb-10 text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400 animate-gradient-rotation ">Projects</h2>
